...
for(trialNum in 1:1000) {
    ...
    save(indiv_results_theta, file = paste0('../Output_noWater/test_results/indiv_test_', trialNum, '.rda'))
    save(global_results_theta, file = paste0('../Output_noWater/test_results/global_test_', trialNum, '.rda'))
}
...
for(t in 1:1000) {
    ...
    load(paste0('../Output_noWater/test_results/indiv_test_', t, '.rda'))
    all_indiv[t,,] = indiv_results_theta

    load(paste0('../Output_noWater/test_results/global_test_', t, '.rda'))
